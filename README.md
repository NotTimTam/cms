...
-   Page &mdash; A "place" on the site, generally a page. Can display an article, module, or some other predefined (user-customizable) content type, such as a blog layout. Pages can be found in a menu structure, or standalone.
...
-   Plugin &mdash; A plugin will extend the features of the site in some way. They can introduce new modules, page types, or overall features. They should be universally installable, and able to access and manipulate the API of the site with permission.
...
A component is any "document" in the system. Articles, users, plugins, pages, are **all** components.

### Article

A main piece of content on the site.

### Module

A smaller piece of content on the site. Can be a part of an article or a specific part of a page.

### Page

A route location on the site.
...
-   Global template and templates for specific pages.
